...
public class GoogleMobileAdsDemoScript : MonoBehaviour
{
    ...
    private void RequestBanner()
    {
        ...
        #elif UNITY_ANDROID
			string adUnitId = "ca-app-pub-7915864464757285/5640706256";
        #elif UNITY_IPHONE
			string adUnitId = "ca-app-pub-7915864464757285/1210506658";
		#else
    ...
    private void RequestInterstitial()
    {
            ...
            string adUnitId = "unused";
        #elif UNITY_ANDROID
			string adUnitId = "ca-app-pub-7915864464757285/7117439456";
        #elif UNITY_IPHONE
			string adUnitId = "ca-app-pub-7915864464757285/2687239854";
		#else
            string adUnitId = "unexpected_platform";
        #endif
